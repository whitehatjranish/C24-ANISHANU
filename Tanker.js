class Tanker {
  constructor(x, y, width, height) {
    ...
    display(){
      ...
      if(keyIsDown(RIGHT_ARROW) && angle > -1.5708){
        angle -=0.05
      ...
      launcherX = pos.x + ((this.height+200) * cos(angle))
      launcherY = pos.y - ((this.height-200) * sin(angle))
